...
import (
	...
	_ "k8s.io/client-go/plugin/pkg/client/auth" // client auth plugins (Azure, GCP, OIDC, ...)
...
func main() {
	...
	flag.StringVar(&metricsAddr, "metrics-bind-address", ":9090", "The address the metrics endpoint binds to. "+
		"Use :9090 for HTTP, or leave as 0 to disable the metrics service.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "48b6cd2f.inference-gateway.com",
